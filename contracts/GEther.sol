...
/**
 * @title Compound's GEther Contract
...
contract GEther is GToken {
     ...
     * @param guptroller_ The address of the Comptroller
     ...
     */
    constructor(GuptrollerInterface guptroller_,
        ...
        initialize(guptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_);
