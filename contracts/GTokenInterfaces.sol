...
contract GTokenStorage {
     ...
     */
    GuptrollerInterface public guptroller;
    ...
    // Initial exchange rate used when minting the first GTokens (used when totalSupply = 0)
...
abstract contract GTokenInterface is GTokenStorage {
    ...
    /**
     * @notice Event emitted when guptroller is changed
     */
    event NewGuptroller(GuptrollerInterface oldGuptroller, GuptrollerInterface newGuptroller);
    ...
    function _setGuptroller(GuptrollerInterface newGuptroller) virtual external returns (uint);
